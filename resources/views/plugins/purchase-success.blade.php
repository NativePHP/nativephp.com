        ...
        >
            ...
            <template x-if="status === 'complete'">
                <div>
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-400">
                        Your payment was successful. You now have access to <strong>{{ $plugin->name }}</strong>.
                    </p>
                        ...
                        <ul class="mt-3 space-y-2 text-sm text-indigo-700 dark:text-indigo-300">
                            ...
                            <li class="flex items-start gap-2">
                                ...
                                @if ($plugin->package_name)
                                    Run <code class="rounded bg-indigo-100 px-1 dark:bg-indigo-900/50">composer require {{ $plugin->package_name }}</code>
                                @else
