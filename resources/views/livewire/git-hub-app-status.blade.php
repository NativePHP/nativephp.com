<div>
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="flex items-center justify-between">
            ...
            @if($slug)
                <a href="https://github.com/apps/{{ $slug }}/installations/new" target="_blank" class="inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600">
                    Add Account
        ...
        @if($installations->isEmpty())
            <div class="mt-4 rounded-md bg-gray-50 p-4 dark:bg-gray-700/50">
                ...
                @if($slug)
                    <a href="https://github.com/apps/{{ $slug }}/installations/new" class="mt-3 inline-flex items-center rounded-md bg-gray-900 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gray-700 dark:bg-gray-600 dark:hover:bg-gray-500">
