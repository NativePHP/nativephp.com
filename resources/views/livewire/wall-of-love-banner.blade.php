<div @class(['max-w-7xl mx-auto px-4 sm:px-6 lg:px-8' => !$inline])>
    @if($this->shouldShowBanner())
        <div class="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-6" x-data x-on:banner-dismissed.window="$el.style.display='none'">
