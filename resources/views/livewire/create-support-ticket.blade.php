<section class="mx-auto mt-10 max-w-2xl px-5 md:mt-14">
    {{-- Header --}}
    <header class="mb-10 text-center">
        <h1 class="text-4xl font-bold md:text-5xl dark:text-white/90">Submit a Request</h1>
    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 md:p-8 dark:border-gray-700 dark:bg-gray-900">
        <form wire:submit="submit">
            ...
            <div class="mt-8 flex flex-col-reverse gap-3 sm:flex-row sm:justify-between">
                @if ($currentStep === 1)
                    <a href="{{ route('support.tickets') }}" class="inline-flex items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm transition duration-200 hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700">
    ...
    <div class="mt-12 rounded-xl bg-gradient-to-br from-[#FFF0DC] to-[#E8EEFF] p-4 md:mt-20 md:p-8 dark:from-blue-900/10 dark:to-[#4c407f]/25">
        <h2 class="mb-3 text-xl font-medium md:mb-4 md:text-2xl">Need more help?</h2>
