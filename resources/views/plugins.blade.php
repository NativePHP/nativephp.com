    ...
    <div class="mx-auto max-w-7xl">
        ...
        <section class="mt-12">
            <a
                ...
                class="group block overflow-hidden rounded-2xl bg-gradient-to-r from-purple-600 via-indigo-600 to-purple-700 p-6 shadow-lg transition hover:shadow-xl sm:p-8"
            >
                <div class="flex flex-col items-center justify-between gap-6 sm:flex-row">
                    <div class="flex items-center gap-4 text-white">
                        ...
                        <div>
                            <h3 class="text-xl font-bold sm:text-2xl">Plugin Dev Kit</h3>
