<x-layout title="License Details">
        ...
        <header>
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-6">
                    <div>
                        <a href="{{ route('customer.licenses.list') }}" class="inline-flex items-center space-x-2 text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400">
                            <svg class="size-4" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clip-rule="evenodd"></path>
                            </svg>
                            <span class="text-sm font-medium">Licenses</span>
                        </a>
                ...
                <div class="border-t border-gray-200 dark:border-gray-700">
                    <dl>
                        <div class="bg-gray-50 dark:bg-gray-700 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2 flex items-center" x-data="{ show: false }">
                                <div class="flex items-center justify-between w-full">
                                    ...
                                    <div class="ml-2 flex items-center gap-2">
                                        <button
                                            type="button"
                                            @click="show = !show"
                                            class="inline-flex items-center text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
                                        >
    ...
    {{-- Create Key Modal --}}
    <div id="createKeyModal" class="hidden fixed inset-0 bg-black/30 dark:bg-black/50 backdrop-blur-sm overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border border-gray-200 dark:border-gray-700 w-96 shadow-[0_20px_50px_rgba(0,0,0,0.3)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.6)] rounded-lg bg-white dark:bg-gray-800">
            <div class="mt-3">
                <div class="flex items-center justify-between">
                ...
                <form method="POST" action="{{ route('customer.licenses.sub-licenses.store', $license->key) }}" class="mt-4">
                    ...
                    <div class="mb-4">
                        ...
                        />
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Assign this license to a team member.</p>
                    </div>
    ...
    {{-- Edit Key Modal --}}
    <div id="editSubLicenseModal" class="hidden fixed inset-0 bg-black/30 dark:bg-black/50 backdrop-blur-sm overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border border-gray-200 dark:border-gray-700 w-96 shadow-[0_20px_50px_rgba(0,0,0,0.3)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.6)] rounded-lg bg-white dark:bg-gray-800">
            <div class="mt-3">
                <div class="flex items-center justify-between">
    ...
    <div id="editLicenseNameModal" class="hidden fixed inset-0 bg-black/30 dark:bg-black/50 backdrop-blur-sm overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border border-gray-200 dark:border-gray-700 w-96 shadow-[0_20px_50px_rgba(0,0,0,0.3)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.6)] rounded-lg bg-white dark:bg-gray-800">
            <div class="mt-3">
                <div class="flex items-center justify-between">
