    ...
    <div class="mx-auto mt-10 max-w-2xl px-4 sm:px-6 lg:px-8">
        @if ($isFreeCheckout ?? false)
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-8 text-center dark:border-gray-700 dark:bg-gray-800">
                ...
                <h1 class="mt-6 text-2xl font-bold text-gray-900 dark:text-white">Plugins Added!</h1>
                            ...
                            @foreach ($cart->items as $item)
                                @if ($item->plugin)
                                    <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-700/50">
                                        ...
                                        <a href="{{ route('plugins.show', $item->plugin->routeParams()) }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300">
                                            View Plugin
                                        </a>
                                    </div>
                                @endif
