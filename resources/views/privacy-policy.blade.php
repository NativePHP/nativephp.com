<x-layout title="Blog">
    ...
    >
        ...
        >
            <p>
                Bifrost Technology, LLC operates the nativephp.com website,
            ...
            <p>
                ...
                Information if anyone decided to use our Service, the NativePHP
                website.
            </p>
            ...
            <p>
                ...
                We only ask for the essential information we need to operate.
            </p>
            ...
            <p>
                For further information, you should consult the privacy policies
            ...
            <h1>Cookie Policy</h1>
            <p>
                Bifrost Technology, LLC ("us", "we", or "our") uses cookies on
                nativephp.com (the "Service"). By using the Service, you consent
            ...
            <p>
                ...
                and allows the Service or a third-party to recognize your
                browser and make your next visit easier and the Service more
                useful to you.
            </p>

            <p>
                Cookies can be "persistent" - they are persisted between
                browsing sessions - or "session" cookies, which are deleted by
                your browser when you end your session or after a certain time
                limit.
            </p>

            <p>
                Cookies are associated with the browser, not the person, so they
                do not usually store sensitive information about you such as
                credit cards or bank details, photographs or personal
                information etc. The data they keep are of a technical nature,
                statistics, personal preferences, personalization of contents
                etc.
            </p>
            ...
            <p>
                ...
                cookie files in your web browser.
            </p>
            ...
            <ul>
                <li>
                    ...
                    <p>
                        These allow the proper functioning of the web features.
                        Allow the user to navigate through a web page, platform
                        or application and the use of different options or
                        services that exist in it, such as controlling traffic
                        and data communication, identifying the session, access
                        restricted access parts, remember the elements that make
                        up an order, perform the purchase process of an order,
                        make the request for registration or participation in an
                        event, use security elements during navigation, store
                        contents for dissemination of videos or sound or share
                ...
                <li>
                    ...
                    <p>
                        Those that are well treated by us or by third parties,
                        allow us to quantify the number of users and thus
                        perform the measurement and statistical analysis of the
                        use made by users of the service offered. For this, your
                        browsing on our website is analyzed in order to improve
                        the offer of products or services we offer.
                    </p>
                </li>
                <li>
                    <strong>Third-party Cookies</strong>
                    <p>
                        The Site may use third-party services that, on behalf of
                        Google, will collect information for statistical
                        purposes, the use of the site by the user and for the
                        provision of other services related to the website
                        activity and other services from Internet.
                    </p>
                </li>
            </ul>
            ...
            <p>
                At any time, you can adapt the browser settings to manage,
                disregard the use of Cookies and be notified before they are
                downloaded.
            </p>
