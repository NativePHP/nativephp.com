    ...
    <div class="mx-auto max-w-5xl">
        ...
        <section class="mt-12">
            <div class="grid place-items-center text-center">
                ...
                >
                    We're helping teams just like yours build beautiful mobile
                    and desktop apps faster than ever!
                </p>
        ...
        <section class="mt-24">
            ...
            >
                ...
                <x-benefit-card>
                    ...
                    <x-slot name="description">
                        Have a direct line to our development team and influence
                        our feature development to ensure your business needs
                        are met.
                    </x-slot>
                </x-benefit-card>
                ...
                <x-benefit-card>
                    ...
                    <x-slot name="description">
                        Comprehensive training and onboarding for your team to
                ...
                <x-benefit-card>
                    ...
                    <x-slot name="description">
                        Just need someone to build your app? We'll be delighted
                        to!
                    </x-slot>
                </x-benefit-card>
                ...
                <x-benefit-card>
                    ...
                    <x-slot name="description">
                        Become a strategic partner in the NativePHP ecosystem
                        with co-marketing opportunities.
                    </x-slot>
                </x-benefit-card>
            </div>
        </section>
                ...
                <div class="mt-8 space-y-5">
                    <div class="flex gap-3.5">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-gray-600 dark:text-gray-400">
                                Businesses building mobile applications that
                                want to leverage PHP and Laravel expertise.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-3.5">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-gray-600 dark:text-gray-400">
                                Agencies looking to expand their service
                                offerings with native mobile app development.
                            </p>
                        </div>
                    </div>
        ...
        <section class="mt-16 pb-24">
            ...
            >
                ...
                >
                    Contact our team to discuss how a partnership with NativePHP
                    can benefit your business and help you deliver exceptional
                    applications.
                </p>
