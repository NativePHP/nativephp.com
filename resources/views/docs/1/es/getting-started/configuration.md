...
El comando `native:install` publica un archivo de configuración en `config/nativephp.php`. 
Este archivo contiene todas las opciones de configuración para NativePHP.
...
Cuando tu aplicación NativePHP se inicie, es posible que desees personalizar las directivas de php.ini que se utilizarán para tu aplicación.

Puedes configurar estas directivas a través del método `phpIni()` en tu `NativeAppServiceProvider`.
Este método debe devolver un array de las directivas de php.ini que se deben establecer.
