<div class="relative z-40 lg:hidden">
    ...
    >
        <div class="px-5 py-3">
            ...
            <nav class="mt-5 flex flex-col items-start">
                {{-- Link --}}
                <a
                    href="/"
                    @class([
                        'py-2.5 transition duration-200',
                ...
                <a
                    ...
                    @class([
                        'py-2.5 transition duration-200',
                        'font-medium' => request()->is('docs/1/getting-started/sponsoring'),
                        'opacity-50 hover:translate-x-1 hover:opacity-100' => ! request()->is(
                            'docs/1/getting-started/sponsoring',
                        ),
                    ])
                    aria-label="Sponsor NativePHP"
                    title="Support NativePHP development"
                    aria-current="{{ request()->is('docs/1/getting-started/sponsoring') ? 'page' : 'false' }}"
                >
                    Sponsor
                </a>
