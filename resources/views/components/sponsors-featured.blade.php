...
<a href="https://beyondco.de/?utm_source=nativephp&utm_medium=logo&utm_campaign=nativephp" title="BeyondCode sponsor">
    <img src="/img/sponsors/beyondcode.png" class="block dark:hidden {{ $height }} max-w-full">
    <img src="/img/sponsors/beyondcode-dark.png" class="hidden dark:block {{ $height }} max-w-full">
</a>
