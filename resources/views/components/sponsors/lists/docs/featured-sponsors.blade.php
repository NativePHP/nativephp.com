<a
    ...
    class="inline-grid h-20 w-52 shrink-0 place-items-center rounded-2xl bg-gray-100 p-5 transition duration-200 hover:scale-105 hover:bg-gray-200/70 hover:ring-1 hover:ring-black/60 dark:bg-gray-900/40 dark:hover:bg-[#181a25]/70 dark:hover:ring-white/15"
>
    <img
