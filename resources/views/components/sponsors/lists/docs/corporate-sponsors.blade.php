<a
    ...
    class="inline-grid h-20 w-52 shrink-0 place-items-center rounded-2xl bg-gray-100 p-5 transition duration-200 will-change-transform hover:scale-105 hover:bg-gray-200/70 hover:ring-1 hover:ring-black/60"
    title="RedGalaxy"
>
...
{{--
    ...
    class="inline-grid h-20 w-52 shrink-0 place-items-center rounded-2xl bg-gray-100 p-5 transition duration-200 hover:ring-1 will-change-transform hover:scale-105 hover:ring-black/60 hover:bg-gray-200/70"
