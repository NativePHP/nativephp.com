<div class="relative bg-gray-50 text-white">
    <div
        class="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-3 sm:py-4"
    >
        <a
            href="/"
        ...
        >
            <svg class="h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 764 100">
                <title>NativePHP logo (by Caneco)</title>
