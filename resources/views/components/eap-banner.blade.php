<a
    ...
    class="group flex items-center justify-center gap-2 bg-gradient-to-r from-[#352F5B] to-[#6056AA] px-2 py-2.5"
>
    <style>
        @keyframes shine {
            0% {
    ...
    <svg
        ...
        viewBox="0 0 15 11"
        fill="none"
        class="transition duration-300 ease-in-out will-change-transform group-hover:translate-x-1"
    >
        <path
