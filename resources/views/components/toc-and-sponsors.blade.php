...
{{-- On this page --}}
<h3
    class="mt-5 flex items-center gap-1.5 border-t border-t-black/20 pt-5 text-sm opacity-60 dark:border-t-white/15"
>
    {{-- Icon --}}
...
@if (count($tableOfContents) > 0)
    <div
        class="mt-4 flex max-h-[clamp(11rem,50vh,35vh)] flex-col space-y-2 overflow-y-auto overflow-x-hidden border-l text-xs dark:border-l-white/15"
    >
